            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                <form method="POST" action="/admin/posts/{{ $post->id }}" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-2">
                        ...
                        <input type="file" name="thumbnail" class="form-control" value="{{ old('thumbnail', $post->thumbnail) }}">
                        @error('thumbnail')
                        <div class="alert alert-danger small mt-3" role="alert">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-outline mb-2">
                        ...
                        <input type="text" name="excerpt" class="form-control" value="{{ old('excerpt', $post->excerpt) }}" required>
                        @error('excerpt')
                        <div class="alert alert-danger small mt-3" role="alert">
                            {{ $message }}
                        </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-lg my-3" name="published" value="0">
                        {{ $post->published ? 'Zamień na wersję roboczą' : 'Zapisz' }}
                    </button>
                    <button type="submit" class="btn btn-primary btn-lg my-3" name="published" value="1">
                        Publikuj
                    </button>
                </form>
            </div>
